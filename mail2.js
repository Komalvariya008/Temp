  ...
  for (let i = 0; i < values.length; i++) {
    ...
    try {
      ...
      const qrCode = new QRCodeCanvas({
        ...
        imageOptions: { "hideBackgroundDots": false, "imageSize": 1, "margin": 0 },// Replace 'https://example.com/logo.png' with the direct URL to your logo image (PNG or JPG)
        dotsOptions: {
          type : 'Classy rounded',
          gradient: {
            type: 'radial',
